...
I et arbejdsområde skal du vælge fanen **Dashboards** og derefter vælge ikonet **Få vist relaterede**![](media/service-related-content/power-bi-view-related-icon-new.png).
...
Vælg ![](media/service-related-content/power-bi-view-related-new.png) fra den øverste menulinje med et åbent dashboard.
...
I et arbejdsområde skal du vælge fanen **Rapporter** og derefter vælge ikonet **Få vist relaterede**![](media/service-related-content/power-bi-view-related-icon-new.png).
...
I et arbejdsområde skal du vælge fanen **Datasæt** og finde ikonet **Få vist relaterede**![](media/service-related-content/power-bi-view-related-icon-new.png).
