...
description: Dette er ofte stillede spørgsmål om datagatewayen i det lokale miljø til Power BI. Her samler vi ofte stillede spørgsmål om den gateway, der bruges i Power BI, på ét sted.
author: mgblythe
manager: kfile
ms.reviewer: ''
ms.service: powerbi
