...
* Generel tilgængelighed i forbindelse med udarbejdning af brugerdefineret navigation til [Power BI-apps](../collaborate-share/service-create-distribute-apps.md).
...
* Forbedringer af ydeevne for [Multi-Geo Premium-kapaciteter](../admin/service-admin-premium-multi-geo.md).
* Offentlige prøveversion af [XMLA-slutpunkter for læsning/skrivning](../admin/service-premium-connect-tools.md) i Power BI Premium.
...
* Nye og forbedrede [forbrugsdata](../collaborate-share/service-usage-metrics.md) til Power BI-arbejdsområdeoplevelsen.
...
* Opdateringer til konfiguration af forbindelse for [skabelonapps](../connect-data/service-template-apps-overview.md).
...
* Generel tilgængelighed af Power BI-[sammenlægninger](../transform-model/desktop-aggregations.md).
...
* Offentlig prøveversion af [delte og certificerede datasæt](../connect-data/service-datasets-across-workspaces.md).
* Metrikværdier for kunstig intelligens tilgængelig i [appen Premium Capacity Metrics](../admin/service-admin-premium-monitor-capacity.md).
* Generel tilgængelighed af [skabelonapps](../connect-data/service-template-apps-overview.md) i Power BI.
...
* Offentlig prøveversion af [BYOK](../admin/service-encryption-byok.md) (Bring Your Own Key) til Power BI Premium.
* Rollen Fremviser for [oplevelsen med de nye arbejdsområder](../collaborate-share/service-new-workspaces.md).

### <a name="may-2019"></a>Maj 2019
* [Brugerdefineret navigation](../collaborate-share/service-create-distribute-apps.md) til Power BI-apps.
...
* [Cachelagring af forespørgsler](../connect-data/power-bi-query-caching.md) er tilgængelig i Power BI Premium.
...
* [Mailabonnementer efter behov](../collaborate-share/service-publish-to-web.md).
...
* Forbedringer af Power BI-[rapportens URL-adressefilter](../collaborate-share/service-url-filters.md).
...
* [Multi-Geo-understøttelse](../admin/service-admin-premium-multi-geo.md) for Power BI Premium.
...
* [Temadashboards](../create-reports/service-dashboard-themes.md) i Power BI-tjenesten.
* [Trinvis opdatering](../admin/service-premium-incremental-refresh.md) med Premium.
* Anmod om adgang til arbejdsgang for [Power BI-apps](../collaborate-share/service-create-distribute-apps.md).
* Få opdateringer af Data for at gøre det nemmere for brugerne at finde [Power BI-apps](../collaborate-share/service-create-distribute-apps.md).
...
* Installér automatisk [Power BI-apps](../collaborate-share/service-create-distribute-apps.md) for slutbrugere.
...
*    Selektiv publicering af indhold med [Power BI Apps](../collaborate-share/service-create-distribute-apps.md).
...
* Forbedret indlæsningsydeevne for [forbrugsdata](../collaborate-share/service-usage-metrics.md).
...
* Kom i gang med [Power BI-tjenesteapps](../connect-data/service-connect-to-services.md) til onlinetjenester.
...
* Måling og øgning af din påvirkning med [forbrugsdata for dashboards og rapporter](../collaborate-share/service-usage-metrics.md).
...
Opdateringer til rapporter og visuelle elementer:
...
Der er mange opdateringer i denne uge, som hovedsageligt gælder for Power BI Desktop, men også betydelige opdateringer til oprettelse af rapporter og samt visuelle elementer. [Power BI-teamets blog](https://powerbi.microsoft.com/blog/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features/) indeholder komplette beskrivelser og en video, der beskriver opdateringerne.   
...
Få alle detaljerne, herunder en video, der demonstrerer mange af disse opdateringer, på [Power BI-bloggen](https://powerbi.microsoft.com/blog/more-power-bi-feature-updates-power-bi-desktop-december-update-and-new-power-bi-service-features/).
...
* Skift interaktioner mellem visuelle elementer i rapporter
  ...
  Du kan få alle detaljerne ved at [besøge Power BI-teamets blog](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1210/).
...
* Automatisk registrering af tendenser og afdækning af mønstre i et datasæt med Hurtig indsigt: [video](https://powerbi.microsoft.com/blog/power-bi-updates-from-browser-to-desktop-and-new-automated-insights-mf/) eller [artikel](../consumer/end-user-insights.md)
* [Visualiser dine VMob-data i Power BI](https://powerbi.microsoft.com/blog/visualize-your-vmob-data-in-power-bi/)
* [Previewversion af Power BI-gateway til virksomheder](https://powerbi.microsoft.com/blog/announcing-preview-of-power-bi-gateway-for-enterprise-deployments/)
* Introduktion af en ny indholdspakke: [Søgeanalyse fra Bing på Power BI-dashboards](https://powerbi.microsoft.com/blog/search-analytics-from-bing-on-your-power-bi-dashboards/)
* Nye udviklerfokuserede forbedringer: [To nye API'er og nemmere appregistrering](https://powerbi.microsoft.com/blog/power-bi-for-developers-reports-api-and-a-simple-app-registration-experience)
...
Du kan få alle detaljerne ved at besøge [Power BI-bloggen](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1124/)
...
Du kan få alle detaljerne ved at besøge [Power BI-bloggen](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1117/)
...
Du kan få alle detaljerne ved at besøge [Power BI-bloggen](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1110/)
...
Du kan få alle detaljerne ved at besøge [Power BI-bloggen](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1103/)
...
Du kan få alle detaljerne ved at besøge [Power BI-bloggen](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1027/)
...
Du kan få alle detaljerne ved at besøge [Power BI-bloggen](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1020/)
...
Se vores [blog](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-1013/) og [onlinedokumentation](service-get-started.md) for at få mere at vide.

**6. oktober 2015**

* Med Spørgsmål og svar i Power BI kan du udforske dine data ved hjælp af enkle, intuitive spørgsmål og få svar i form af interaktive diagrammer og grafer. I denne udgivelse har vi tilføjet en funktion, der kan hjælpe dig med at komme i gang med Spørgsmål og svar i Power BI, selvom du ikke ved noget om dataene. For at komme i gang med dette skal du [gå til et hvilket som helst dashboard og klikke på linket "Sådan spørger du" i nærheden af spørgsmålsfeltet for Spørgsmål og svar](../create-reports/power-bi-tutorial-q-and-a.md). Power BI giver dig en række forslag, der er baseret på dine data.
...
Se [bloggen](https://powerbi.microsoft.com/blog/power-bi-service-weekly-update-10-06/) og [onlinedokumentationen](service-get-started.md) for at få mere at vide.
...
* Du kan nu [dele (og afslutte deling af) et dashboard fra dit gruppeområde](../collaborate-share/service-collaborate-power-bi-workspace.md) på samme måde, som du ville gøre det i dit eget område. Når kollegaerne accepterer din delingsinvitation, tilføjes det delte dashboard (og de tilknyttede rapporter) i deres eget område i en skrivebeskyttet udgave, hvor de kun har tilladelse til at læse.
* Vi har føjet yderligere fem [brancherelaterede eksempler](../create-reports/sample-datasets.md) til Power BI: Customer Profitability (Eksempel på kunderentabilitet), Human Resources (Eksempel på HR), Opportunity Analysis (Eksempel på analyse af salgsmuligheder), Procurement Analysis (Eksempel på indkøbsanalyse) og Sales and Marketing Sample (Eksempel på salg og marketing).
* Stripe er en avanceret betalingsplatform til onlinevirksomheder. Fra nystartede virksomheder til Fortune 500-selskaber – tusindvis af virksomheder bruger Stripe til at modtage betalinger i mere end 130 valutaer fra alle i hele verden. Hvis du forbinder Power BI med din eksisterende Stripe-konto, vil du kunne [bruge Power BI Stripe-indholdspakken til at overvåge, udforske og visualisere dine Stripe-aktivitet](../connect-data/service-connect-to-services.md).

[Få mere at vide på vores blog](https://powerbi.microsoft.com/blog/power-bi-weekly-service-update-0922/).
...
* comScore Digital Analytix er en onlineløsning, der giver indsigt i din brugerbase vha. det bedste inden for analyse og målgruppedemografi. Med Power BI comScore-indholdspakken kan du hurtigt oprette forbindelse og begynde at få indsigt i dine webanalysedata. Denne indholdspakke indeholder et køreklart dashboard, et sæt af rapporter og et udvalgt datasæt, der kan hjælpe dig med at udforske og analysere dine data. Få mere at vide om indholdspakken på vores [blog](https://powerbi.microsoft.com/blog/visualize-and-explore-your-comscore-data-with-power-bi/) og [Hjælp-emne](../connect-data/service-connect-to-services.md). 
...
* Vi har en ny indholdspakke til tyGraph, som gør det nemt at få bedre indsigt i dine Yammer-data. Indholdspakken inkluderer et dashboard, et sæt af rapporter og et udvalgt datasæt til at udforske og give dig indsigt, f.eks. Measure of Active Engagement (MAE Score), og metrikværdier for forbrug af indhold, f.eks. File Views (filvisninger) og File Downloads (fildownloads). Få mere at vide på vores [blog](https://powerbi.microsoft.com/blog/analyze-and-monitor-your-tygraph-data-with-power-bi/) og i [Hjælp-emnet](../connect-data/service-connect-to-services.md).

**1. september 2015**

* Webtrends hjælper virksomheder med at finde mening i deres kundedata for at skabe grobund for vellykket digital marketing. Brugerne har mulighed for at se, analysere og levere indsigt på den besøgendes rejse på tværs af websteder, sociale medier, mobiloplevelser og SharePoint-kanaler. Med udgivelsen af [Webtrends-indholdspakken](https://powerbi.microsoft.com/blog/visualize-and-explore-your-webtrends-data-in-power-bi/) har brugerne nu mulighed for at bruge Power BI til at overvåge, analysere og visualisere deres Webtrends-analysedata. Der er flere oplysninger på [Hjælp-siden](../connect-data/service-connect-to-services.md) til Webtrends-indholdspakken til Power BI.
...
* Vi er glade for at kunne meddele, at denne uges opdatering til Power BI nu tilbyder registrering af ydeevne for databaser med [SQL Sentry-indholdspakken](https://powerbi.microsoft.com/blog/monitoring-your-sql-sentry-data-with-power-bi/). Denne indholdspakke indeholder et dashboard og rapporter, der kan hjælpe dig med at overvåge de SQL Server-installationer, du sporer ved hjælp af SQL Sentry-skyen. Hvis du vil have mere at vide om, hvordan du kommer i gang, skal du se [siden med hjælp](../connect-data/service-connect-to-services.md) til SQL Sentry-indholdspakken til Power BI.
...
* En af de mest ventede og efterspurgte funktioner er nu tilgængelig i Power BI. Fra og med i dag kan du i Power BI [opdatere datasæt](https://powerbi.microsoft.com/blog/refresh-for-on-premises-sources-is-here/) ved at oprette forbindelse til dine datakilder i det lokale miljø, f.eks. SQL Server. Du kan opdatere et datasæt, der er oprettet ud fra en Power BI Designer-fil eller en Excel-projektmappe, med data, der importeres til projektmappen ved hjælp af Power Query eller Power Pivot. 

**30. juni 2015**

* Vi har udgivet en ny [Power BI UserVoice-indholdspakke](https://powerbi.microsoft.com/blog/monitor-and-visualize-your-uservoice-data-with-power-bi/), der kan hjælpe dig med at overvåge og visualisere dine UserVoice-data og straks få indsigt i dem med et dashboard og en rapport, som er klar til brug.

**23. juni 2015**

* Power BI Desktop-filer kan [opdateres](https://powerbi.microsoft.com/blog/announcing-refresh-support-for-power-bi-designer-files-in-the-power-bi-service/) (planlagt opdatering og øjeblikkelig opdatering), når de uploades til Power BI-tjenesten.
* Vi frigiver den største visuelle ændring til Power BI siden december: en mere strømlinet og enkel oplevelse for [Hent data](https://powerbi.microsoft.com/blog/the-new-get-data-experience/).  Når du klikker på Hent data, får du nu vist et enkelt skærmbillede med et sæt af kategorier at vælge imellem. Det gør det endnu nemmere at finde det indhold, der er vigtigt for dig.
* [Azure SQL Data Warehouse](https://powerbi.microsoft.com/blog/exploring-azure-sql-data-warehouse-with-power-bi/) giver elastisk skalering og omfattende parallel behandling. I kraft af den begrænsede offentlige previewversion, vi har annonceret i dag, kan du nu bruge Power BI til at oprette direkte forbindelse til data, der er gemt i dit Azure SQL Data Warehouse, hvilket giver mulighed for enkel og dynamisk udforskning. Når du har oprettet en forbindelse til dit data warehouse, genereres der forespørgsler i realtid, som sendes til tilbage til kilden, når du udforsker dataene. Dette fjerner behovet for at oprette og uploade en brugerdefineret datamodel, og du får en interaktiv udforskning af dine data.

**16. juni 2015**

* Med SweetIQ kan du nemt spore dine lokale fortegnelser ved at levere placerings- og revisionsdata fra dit lokale søgeøkosystem. Power BI gør det muligt at analysere og overvåge disse data ved at tilbyde [køreklart indhold](https://powerbi.microsoft.com/blog/analyze-and-monitor-your-sweetiq-data-with-power-bi/), som er opbygget ud fra dine SweetIQ-data. Hvis du vil have mere at vide om, hvordan du kommer i gang, skal du se [siden med hjælp](../connect-data/service-connect-to-services.md) til SweetIQ-indholdspakken til Power BI.

**2. juni 2015**

* Med Power BI og [appFigures-indholdspakken](https://powerbi.microsoft.com/blog/explore-and-analyze-your-appfigures-data-with-power-bi/) er det nu blevet nemt at spore vigtige statistikker om dine apps. Hvis du vil have mere at vide om, hvordan du opretter forbindelse og kommer i gang, skal du se [dokumentationen](../connect-data/service-connect-to-services.md) til appFigures-indholdspakken til Power BI.
...
* Du kan oprette direkte forbindelse til data, der er gemt i din **Azure SQL Database**. Vi genererer og sender dynamiske forespørgsler til kilden, så du kan oprette interaktive rapporter direkte via din database. Du kan læse [blogindlægget](https://powerbi.microsoft.com/blog/using-power-bi-to-visualize-and-explore-azure-sql-databases/) og [dokumentationen](../connect-data/service-azure-sql-database-with-direct-connect.md) for at få mere at vide.
...
* Power BI fås nu på **44 sprog**. Læs vores [blogindlæg](https://powerbi.microsoft.com/blog/power-bi-preview-now-available-in-your-language/) for at se en fuldstændig liste.

**23. april 2015**

* Nu kan du visualisere og udforske dine **Microsoft Dynamics Marketing**-data med vores nye indholdspakke! Du kan læse vores [blogindlæg](https://powerbi.microsoft.com/blog/monitor-and-explore-your-microsoft-dynamics-marketing-data-with-power-bi/), hvis du vil have mere at vide.

**15. april 2015**

* Nu kan du visualisere og udforske dine **Google Analytics**-data med vores nye indholdspakke! Med Google Analytics-indholdspakken får du vist et dashboard, en rapport og et datasæt, der giver dig mulighed at få indblik i brugen af webstedet i løbet af de seneste seks måneder. Du kan læse [vores blogindlæg](https://powerbi.microsoft.com/blog/visualize-and-explore-your-google-analytics-data-with-power-bi/).
