...
description: Krav og proces til afsendelse af en brugerdefineret visualisering til certificering. Og en liste over certificerede Power BI-visuals.
author: KesemSharabi
ms.author: kesharab
ms.reviewer: ''
featuredvideoid: ''
...
> [!IMPORTANT]
> Microsoft kan efter eget skøn fjerne et Power BI-visual fra listen [Certificerede Power BI-visuals](#certified-power-bi-visuals).
...
* Godkendt via Microsoft Sælgerdashboard eller Partnercenter. Dit Power BI-visual bør være i [Marketplace](https://appsource.microsoft.com/marketplace/apps?page=1&product=power-bi-visuals).
...
* Krav til kodelager:
  ...
  * [TSlint fra Microsoft](https://www.npmjs.com/package/tslint-microsoft-contrib) skal være inkluderet uden nogen tilsidesatte konfigurationer. Denne kommando må ikke returnere nogen lint-fejl.
   * Den kompilerede pakke for Power BI-visual'et skal svare til den indsendte pakke.
* Kildekodekrav:
   * Power BI-visualiseringen skal understøtte [API'en til gengivelse af hændelse](./visuals/event-service.md).
