---
title: Integreret analyse til integrering af Power BI-indhold i dit program til offentlige og nationale cloudmiljøer
...
* Government Community Cloud (GCC):
    ...
    > [!Note]
    > GCC-konti understøtter kun P- og EM-kapaciteterne.
