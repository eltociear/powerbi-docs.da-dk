...
### <a name="sales-and-marketing-sample--sales-and-marketing-samplemediasample-datasetspower-bi-smpng"></a>Eksempel på salg og marketing  ![Eksempel på salg og marketing](media/sample-datasets/power-bi-sm.png)
...
### <a name="supplier-quality-sample--supplier-quality-samplemediasample-datasetspower-bi-sqpng"></a>Eksempel på leverandørkvalitet  ![Eksempel på leverandørkvalitet](media/sample-datasets/power-bi-sq.png)
...
Som du kunne læse ovenfor, findes eksemplerne i flere formater: indholdspakker, Excel-projektmapper og .pbix-filer. Vi vil nu beskrive, hvordan du bruger hver af disse formater, og starter med indholdspakker.
...
5. Power BI importerer indholdspakken og føjer et nyt dashboard, en rapport og et datasæt til dit aktuelle arbejdsområde. Det nye indhold er markeret med en gul stjerne. Brug eksemplerne til give Power BI en testkørsel.  
   ...
   ![Nyt indhold er markeret med stjerne *](media/sample-datasets/power-bi-asterisk.png)
...
7. Vælg filen – i dette tilfælde **Procurement Analysis Sample.xlsx** – som blev gemt i OneDrive for Business, og vælg **Opret forbindelse**.
...
1. Vælg **Filer > Åbn** i Power BI Desktop, og naviger til det sted, hvor du har gemt .pbix-eksemplet.
   ...
   ![Fil > Åbn i Power BI Desktop](media/sample-datasets/power-bi-desktop-open.png)
