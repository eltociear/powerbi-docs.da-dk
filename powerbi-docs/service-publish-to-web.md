...
> 
> [!IMPORTANT]
> Power BI-administratorer kan deaktivere brugernes mulighed for at bruge Publicer på internettet fra administrationsportalen. Sæt **Publicer på internettet** til **Fra** i **Lejerindstillinger**. Dette er en indstilling for hele lejeren. Se [Power BI-administrationsportal](service-admin-portal.md), hvis du vil have mere at vide.
> 
> 
