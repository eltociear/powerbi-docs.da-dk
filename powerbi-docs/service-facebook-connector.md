...
Facebook udløb facebooks Graph-API v1.0 udløb den 30. April 2015. Power BI bruger Graph-API'en i baggrunden for Facebook-connectoren, hvilket giver dig mulighed for at oprette forbindelse til dine data og analysere dem.

Forespørgsler, der er oprettet før den 30. April 2015 kan ikke længere fungere eller returnerer færre data. Efter 30 April 2015 udnytter Power BI v2.8 i alle kald til Facebook-API'EN. Hvis din forespørgsel blev oprettet før den 30. april 2015, og du ikke har brugt den siden, skal du sandsynligvis godkende igen for at godkende det nye sæt tilladelser, som vi spørger om.
