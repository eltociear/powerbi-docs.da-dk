...
1. Åbn app.powerbi.com, og vælg linket **Eksempler**. 
    ...
    ![åbne Power BI-tjenesten første gang](./media/end-user-experience/power-bi-new-user.png)

2. Vælg **Retail Analysis Sample > Opret forbindelse**.

    ![vælge eksemplet](./media/end-user-experience/power-bi-retail-sample.png)
...
![Åbne dashboards](./media/end-user-experience/power-bi-open-dashboard.png)
...
1. Mens dashboardet er åbent, skal du vælge **Favorit** i øverste højre hjørne.
   ...
   ![tilføj favorit](./media/end-user-experience/powerbi-dashboard-favorite.png)
...
3. Åbn **ruden** *Favoritter* ved at vælge **Favoritter** i navigationsruden eller ved at vælge stjerneikonet ![skærmbillede, der viser et gult stjerneikon](media/end-user-experience/powerbi-star-icon.png).
...
4. Vælg rapportens navn for at åbne rapporten i rapporteditoren.
    ...
    ![åbne rapport](./media/end-user-experience/power-bi-report-open.png)
