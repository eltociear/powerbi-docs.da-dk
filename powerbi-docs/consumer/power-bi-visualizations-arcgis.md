...
Første gang en kollega deler et ArcGIS-kort med dig, viser Power BI en prompt. ArcGIS Maps for Power BI er leveret af Esri (www.esri.com), og din brug af ArcGIS Maps for Power BI er omfattet af Esris vilkår og politik for beskyttelse af personlige oplysninger. Power BI-brugere, der gerne vil bruge ArcGIS-kort til visualiseringer i Power BI, skal acceptere i dialogboksen til samtykke.
...
De funktioner, der er tilgængelige for dig, afhænger af om du er *forfatter* (den person, der har udarbejdet kortet) eller *forbruger* (en, som deler et ArcGIS-kort). Hvis du interagerer med et ArcGIS-kort som forbruger (dvs. [Læsevisning](end-user-reading-view.md)), har du mulighed for at benytte følgende handlinger.

* Hvis du forbruger Premium med *visnings*tilladelser, kan du [få vist de data, der bruges til at oprette visualiseringen](end-user-show-data.md), [abonnere](end-user-subscribe.md), se kortet i [fokustilstand og fuldskærmsvisning](end-user-focus.md), [få vist relateret indhold](end-user-related.md), [arbejde med de filtre](end-user-report-filter.md), der er angivet af *rapportopretteren*, [dele rapporten](../service-share-reports.md) og meget mere.
