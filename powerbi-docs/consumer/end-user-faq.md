...
* [Indholdspakker til tjenester](end-user-connect-to-services.md) med færdiglavede dashboards, rapporter og datasæt til tjenester som f.eks. Salesforce. Udover at etablere en dataforbindelse så indeholder Power BI færdigbyggede dashboards og rapporter til hver af disse tjenester.
...
Her er en komplet liste over [understøttede browsere til Power BI](end-user-browsers.md).
