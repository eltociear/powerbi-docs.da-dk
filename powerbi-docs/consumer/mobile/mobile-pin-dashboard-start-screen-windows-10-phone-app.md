...
description: Du kan få mere at vide om at fastgøre et Power BI-dashboard til startskærmen i Windows 10 fra Power BI-mobilappen.
author: paulinbar
ms.service: powerbi
...
![Windows-felt](./media/mobile-pin-dashboard-start-screen-windows-10-phone-app/power-bi-windows-10-pin-start-screen.png)
...
## <a name="pin-a-dashboard-to-your-start-screen-as-a-tile"></a>Fastgør et dashboard til startskærmen som et felt
1. Åbn et dashboard.
2. Tryk på **Fastgør til start** ![ikonet Fastgør til start](./media/mobile-pin-dashboard-start-screen-windows-10-phone-app/power-bi-windows-10-pin-start-icon.png).
   ...
   ![Windows 10-felt](./media/mobile-pin-dashboard-start-screen-windows-10-phone-app/pbi_win10ph_startscrn.png)
