...
Har du planer om at oprette en app? Se [Opret arbejdsområder med dine kollegaer i Power BI](end-user-create-apps.md) for at få flere oplysninger.
...
* [Opret og publicer apps i Power BI](end-user-create-apps.md)
