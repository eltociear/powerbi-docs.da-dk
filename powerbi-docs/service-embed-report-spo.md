...
description: "Med Power BIs nye rapportwebdel til SharePoint Online kan du nemt kan integrere interaktive Power BI-rapporter på SharePoint Online-sider."
services: powerbi
documentationcenter: 
author: guyinacube
manager: kfile
...
Med Power BIs nye rapportwebdel til SharePoint Online kan du nemt integrere interaktive Power BI-rapporter på SharePoint Online-sider.
...
### <a name="get-a-url-to-your-report"></a>Få en URL-adresse til rapporten

1. Få vist rapporten i Power BI-tjenesten.

2. Vælg menuelementet **Filer**.
...
1. Åbn den ønskede side i SharePoint Online, og vælg **Rediger**.
    ...
    Eller opret et nyt moderne websted ved at vælge **+ Ny** i SharePoint Online.
...
4. Indsæt rapportens URL-adresse til ruden med egenskaber. Dette er den URL-adresse, du har kopieret fra trinnene ovenfor. Rapporten indlæses automatisk.
...
Free-brugere kan få vist rapporter, der er integreret med Power BI-webdelen for SharePoint Online. Du give adgang til Free-brugere på samme måde, som du gør med Pro-brugere, som beskrevet i [Giv adgang til rapporter](#granting-access-to-reports) ovenfor. Det arbejdsområde, hvor rapporten er placeret, skal også understøttes af Premium til Power BI-kapaciteten. 
...
Nedenfor findes en beskrivelse af de indstillinger, der kan tilpasses til Power BI-webdelen for SharePoint Online.
...
Hvis dit Power BI-miljø beder dig om at logge på ved hjælp af Multi-Factor Authentication, bliver du muligvis bedt om at logge på med en sikkerhedsenhed for at bekræfte din identitet. Dette kan ske, hvis du ikke loggede på SharePoint Online ved hjælp af Multi-Factor Authentication, men dit Power BI-miljø kræver en konto, der er godkendt af en sikkerhedsenhed.

> [!NOTE]
> Multi-Factor Authentication understøttes endnu ikke med Azure Active Directory 2.0. Brugerne modtager en meddelelse med ordet *fejl*. Hvis brugeren logger på SharePoint Online igen ved hjælp af deres sikkerhedsenhed, kan de muligvis få vist rapporten.

## <a name="reports-that-do-not-load"></a>Rapporter, der ikke indlæses

Rapporten indlæses muligvis ikke i Power BI-webdelen og kan vise følgende meddelelse.
...
* **Fejl: "Der opstod en fejl, prøv at logge af og på igen og derefter besøge denne side igen. Korrelations-id: udefineret, HTTP-svarstatus: 400, serverens fejlkode 10001, meddelelse: manglende opdateringstoken"**
  ...
  2. Hvis din brugerkonto kræver Multi-Factor Authentication (MFA), skal du sikre, at du logger på SharePoint ved hjælp af din Multi-Factor Authentication-enhed (telefonapp, chipkort osv.)
...
* Du kan opstå tekniske problemer, hvis du bruger Internet Explorer 10. Du kan se de [browsere, der understøttes af Power BI](service-browser-support.md) og [Office 365](https://products.office.com/office-system-requirements#Browsers-section).

## <a name="next-steps"></a>Næste trin

[Tillad eller forbyd, at slutbrugere oprettelser moderne webstedssider](https://support.office.com/article/Allow-or-prevent-creation-of-modern-site-pages-by-end-users-c41d9cc8-c5c0-46b4-8b87-ea66abc6e63b)  
