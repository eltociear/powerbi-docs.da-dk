...
* **Begrænsninger for målinger:** De DAX-funktioner og -udtryk, der kan bruges i målinger, er begrænsede. Autofuldførelse vil endnu engang begrænse de angivne funktioner, og der vil opstå en fejl, hvis der anvendes en ugyldig funktion eller et udgyldigt udtryk. Dette er ganske enkelt for at sikre, at målinger er begrænset til enkle målinger, hvor det er usandsynligt, at de selv forårsager problemer med ydeevnen.
