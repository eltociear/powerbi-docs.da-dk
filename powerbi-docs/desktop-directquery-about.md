...
Brug af **DirectQuery** har muligvis negative konsekvenser, som beskrevet i dette afsnit. Nogle af disse begrænsninger er lidt anderledes, afhængigt af den nøjagtige kilde der bruges. Dette påpeges, hvor det er relevant, og der vil være separate artikler, der behandler de kilder, der er markant anderledes.  
...
Der anvendes en timeout på fire minutter på de enkelte forespørgsler i **Power BI-tjenesten**, og forespørgsler, der tager længere tid, vil mislykkes. Som det tidligere blev understreget, anbefales det, at DirectQuery bruges til kilder, der giver en nærmest interaktiv forespørgselsydeevne. Derfor er denne grænse beregnet til at forhindre problemer med alt for lange kørselstider.
...
* **Begræns antallet af visualiseringer på en side:** Når en side åbnes (eller et udsnitsværktøj på sideniveau eller et filter ændres), opdateres alle visualiseringerne på en side. Der er også en grænse for antallet af forespørgsler, der sendes parallelt. Derfor opdateres nogle visualiseringer i rækkefølge, når antallet af visualiseringer øges, hvilket medfører, at den tid, det tager at opdatere hele siden, øges tilsvarende. Derfor anbefales det at begrænse antallet af visuals på en enkelt side og i stedet anvende flere enkle sider.
...
Lad os sige, at disse trin (fra forrige afsnit i denne sektion) er gennemgået – vi har nu en enkelt visualisering på en side i **Power BI Desktop**, der stadig er langsom. Du kan bruge [Effektivitetsanalyse](desktop-performance-analyzer.md) til at fastlægge de forespørgsler, der sendes til den underliggende kilde af Power BI Desktop. Det er også muligt at få vist sporings-/diagnosticeringsoplysninger, der måske udsendes af den underliggende datakilde. Sådanne sporinger kan også indeholde nyttige oplysninger om, hvordan forespørgslen blev udført, og hvordan den kan forbedres.
