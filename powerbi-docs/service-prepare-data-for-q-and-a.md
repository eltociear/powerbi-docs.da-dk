---
title: Få Excel data til at fungere godt med spørgsmål og svar i Power BI
...
ms.locfileid: "65624972"
---
# <a name="make-excel-data-work-well-with-qa-in-power-bi"></a>Få Excel data til at fungere godt med spørgsmål og svar i Power BI
...
I en Excel-tabel med navnet "Sales", der indeholder kolonnerne "Product", "Month", "Units Sold", "Gross Sales" og "Profit", kan du for eksempel stille spørgsmål om alle disse enheder.  Du kan bede om at få vist salg, samlet fortjeneste efter måned, sortere produkter efter solgte enheder og mange andet. Læs mere om [ved hjælp af spørgsmål og svar i dashboards og rapporter](power-bi-tutorial-q-and-a.md), og [visualiseringstyper, som du kan angive i en forespørgsel med spørgsmål og svar](visuals/power-bi-visualization-types-for-reports-and-q-and-a.md).
