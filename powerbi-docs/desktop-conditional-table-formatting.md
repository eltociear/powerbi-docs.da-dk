...
Du kan oprette en DAX-beregning, som giver forskellige værdier baseret på de betingelser for forretningslogik, du vælger. Det er normalt hurtigere at oprette en DAX-formel end at oprette flere regler i dialogboksen Betinget formatering. 

Følgende DAX-formel anvender f.eks. hex-farveværdier i en ny kolonne for **Rangering efter prisbillighed**, baseret på eksisterende kolonneværdier for **Prisbillighed**:

![DAX-beregning](media/desktop-conditional-table-formatting/conditional-table-formatting_05.png)
