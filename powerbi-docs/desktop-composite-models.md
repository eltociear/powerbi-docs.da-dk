...
Når du bruger DirectQuery, skal du altid være opmærksom på ydeevnen primært for at sikre, at backend-kilden har tilstrækkelige ressourcer til at give brugerne en god oplevelse. En god oplevelse betyder, at visuals opdateres efter fem sekunder eller mindre. Du kan finde flere oplysninger om ydeevne i [Om brug af DirectQuery i Power BI](desktop-directquery-about.md).
