...
Power BI-tjenesten (i browseren) er tilgængelig på følgende 42 sprog:
...
1. Klik på knappen **Funktioner** i øverste højre hjørne af browservinduet:
   ...
   ![Knappen Funktioner i Internet Explorer](media/supported-languages-countries-regions/languages1.png)
...
### <a name="choose-the-locale-to-be-used-when-importing-data-into-power-bi-desktop"></a>Vælg den landestandard, der skal bruges, når du importerer data til Power BI Desktop
...
* Bruger du en af Power BI-mobilapperne? Se [Understøttede sprog i Power BI-mobilapperne](mobile-apps-supported-languages.md) for at få flere oplysninger.
