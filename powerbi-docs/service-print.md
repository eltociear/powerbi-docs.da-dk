...
1. [Åbn feltet i fokuseringstilstand](service-focus-mode.md) ved at vælge ellipsen og vælge ikonet Fokus ![](media/service-print/power-bi-focus-icon.png).
   
    ![](media/service-print/menu-options.png)
2. Åbn feltet i [fuldskærmstilstand](service-fullscreen-mode.md) ved at vælge ikonet for fuld skærm ![](media/service-print/power-bi-full-screen-icon.png) på den øverste navigationslinje.
3. Peg på feltet for at få vist menuen Indstillinger.
   
    ![](media/service-print/menu-options-new.png)
4. Vælg ikonet Udskriv ![](media/service-print/print-icon.png) .     
...
1. [Åbn det visuelle element i fokuseringstilstand](service-focus-mode.md) ved at lade markøren hvilke over feltet og vælge ikonet Fokus ![](media/service-print/power-bi-focus-icon.png) fra det øverste højre hjørne.
