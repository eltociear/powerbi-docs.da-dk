...
2. Du kan slå Y-aksen til eller fra ved at vælge skyderen ud for Y-akse. Lad den stå på **Til**.  Du kan for eksempel vælge at slå X-aksen fra, hvis du vil have mere plads til data.
...
3. For januar var GM% på 35 %, steg til 45 % i april, faldt i juli og steg igen i august. Kan vi se et tilsvarende mønster for salget i dette og sidste år?
4. Tilføj **This Year Sales > Value** og **Last Year Sales** i kurvediagrammet. Skalaen for **GM% Last Year** (den blå streg, der kører langs gitterlinjen 0M %) er meget mindre end skalaen for **Sales**, hvilket gør det svært at sammenligne. Og procentsatserne på Y-aksen er vist ikke så meget værd.      
