...
* På samme måde er der ingen **forespørgselseditor**, når du opretter forbindelse til SAP BW. Du kan ændre indstillingerne for datakilden (f.eks. servernavn) ved at vælge **Rediger forespørgsler > Indstillinger for datakilde**. Du kan ændre indstillingerne for alle variabler ved at vælge **Rediger forespørgsler > Rediger variabler**.
...
* **Ingen aggregering af kolonner:** Det er ikke muligt at ændre aggregeringen for en kolonne på et visuelt element. Det er altid *Opsummer ikke*
...
| Nøgle i forhold til tekst (kort, mellem, lang) |For en SAP BW-egenskab, f.eks. CostCenter, viser feltlisten en enkelt kolonne, Cost Center.  Hvis denne kolonne bruges, vises standardteksten.  Ved at vise skjulte felter er det også muligt at se kolonnen med det entydige navn (der returnerer det entydige navn, som er tilknyttet af SP BW og grunden til, at det er entydigt).<br/> <br/>  Nøglen og alle andre tekstfelter er ikke tilgængelige. |
...
| Standardfilter |En BEx-forespørgsel kan indeholde standardfiltre, som automatisk bruges af SAP BEx Analyzer. Disse filtre vises ikke, og derfor vil den tilsvarende brug i Power BI ikke som standard anvende de samme filtre. |
