...
ms.locfileid: "85235710"
---
# <a name="create-visuals-by-using-r-packages-in-the-power-bi-service"></a>Opret visualiseringer ved hjælp af R-pakker i Power BI-tjenesten
...
De R-pakker, der understøttes i **Power BI-tjenesten**, står i følgende afsnit med titlen **Understøttede pakker**. Hvis du vil anmode om at få understøttet en R-pakke, der ikke findes på denne liste, kan du sende din anmodning til [Ideer til Power BI](https://ideas.powerbi.com).
...
|indsætningspunkt|6.0-78|https://cran.r-project.org/web/packages/caret/index.html|
...
|datasæt|3.4.4|NA|
|dato|1.2-38|https://cran.r-project.org/web/packages/date/index.html|
...
* [Opret Power BI-visuals ved hjælp af R](../create-reports/desktop-r-visuals.md)
